                ...
                try {
                    if (null != loc) {
                        ...
                        if (loc.getErrorCode() == 0) {//可在其中解析amapLocation获取相应内容。
                            location = loc;
                            SPUtils.putString(ShareLocationActivity.this, DatasKey.LOCATION_INFO, gson.toJson(location));
...
//        mIvSearch = (ImageView) findViewById(R.id.iv_search);
    ...
    private void showToastWithErrorInfo(int error) {
        ...
        Toast.makeText(ShareLocationActivity.this.getApplicationContext(), tips, Toast.LENGTH_LONG).show();
    }
