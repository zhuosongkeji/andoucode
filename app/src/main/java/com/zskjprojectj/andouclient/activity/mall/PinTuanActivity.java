...
public class PinTuanActivity extends BaseActivity {
    ...
    private void onBind(PinTuan pinTuan) {
        ...
        pinTuanMustAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
    ...
    void pinTuanClick(View view){
        switch (view.getId()){
            case R.id.recommendGoods1:
            case R.id.recommendGoods2:
            case R.id.recommendGoods3:
                MallGoodsDetailsActivity.start("23");
                break;
        }
    }
